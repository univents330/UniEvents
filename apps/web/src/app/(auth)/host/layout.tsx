...
export default function HostLayout({
	...
	return (
		<div className="min-h-screen bg-linear-to-b from-[#f7fbff] via-[#f3f8ff] to-[#edf5ff]">
			...
			<main className="w-full pt-16 lg:fixed lg:right-0 lg:bottom-0 lg:left-64 lg:overflow-y-auto lg:overflow-x-hidden">
				<div
					aria-hidden
				...
				/>
				<div className="relative px-4 pt-2 pb-6 sm:px-6 md:px-8 md:pt-3 md:pb-8">
					{children}
				</div>
			</main>
		</div>
